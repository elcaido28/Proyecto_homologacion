...
<p class="titulo_from">BUSCAR REPORTES DE HOMOLOGACIÓN POR FECHA</p>
  <form action="reporte_matHomologadas.php" class="con_form" method="post">
...
<p>Otra Busqueda: Por Nº Oficio, Cedula, Apellido</p>
