...
<h3><i class="fa fa-cubes" aria-hidden="true"></i>REVISIÓN DE VALIDACIONES DE CONOCIMIENTOS</h3>
  <br/>
...
<p class="titulo_from">ESTABLECER REVISIÓN</p>
  <form action="modificarPro2_Ehomologa1v.php?id=<?php echo $idv; ?>" class="con_form" method="post">
