...
<p class="titulo_from">BUSCAR REPORTES DE SOLICITANTES POR FECHA</p>
  <form action="reporte_solicitanteFinali.php" class="con_form" method="post">
...
<p>Otra Busqueda: Por Nº Solicitud, Cedula, Apellido</p>
