...
$consulta=mysqli_query($con,"SELECT * from solicitantes S INNER JOIN usuarios U on S.id_usuario=U.id_usuario INNER JOIN homologaciones H on S.id_solicitante=H.id_solicitante
