...
En atención  a la solicitud de revisión de malla, presentada por la/el Sr/Srta. '.$nombres.', proveniente de la '.$unip.', de la Carrera '.$carrerap.', me permito manifestar a usted y por su digno intermedio a los Miembros del H.Consejo Directivo, que luego de efectuada revisión y análisis de la documentación presentada, proceden las siguientes consideraciones:
